...
def ajouter_favori(request):
    if request.method == 'POST':
        try:
            ...
            Favorite.objects.create(user=request.user, lat=lat, lng=lng,
...
def get_favorites(request):
    ...
    favorites_list = [{'id': fav.id, 'lat': fav.lat,
                       'lng': fav.lng,
                       'description': fav.description} for fav in favs]
