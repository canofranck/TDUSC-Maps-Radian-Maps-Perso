...
urlpatterns = [
    ...
    path('get-friend-trajets_ibiza/<int:friend_id>/', tduscmap.views.get_friend_trajets_ibiza, name='get_friend_trajets_ibiza'),
    path('get-friend-trajet-details/<int:trajet_id>/', tduscmap.views.get_friend_trajet_details, name='get_friend_trajet_details'),
    path('get-friend-trajet-details_ibiza/<int:trajet_id>/', tduscmap.views.get_friend_trajet_details_ibiza, name='get_friend_trajet_details_ibiza'),
    path('delete-trajet/<int:trajet_id>/', tduscmap.views.supprimer_trajet, name='delete_trajet'),
    path('delete-trajet_ibiza/<int:trajet_id>/', tduscmap.views.supprimer_trajet_ibiza, name='delete_trajet_ibiza'),
