...
urlpatterns = [
    ...
    path('create_reglage/', tduscmap.views.selectionner_reglage, name='selectionner_reglage'),
    path('get-configuration/<int:car_id>/', tduscmap.views.get_configuration, name='get_configuration'),
]
if settings.DEBUG:
    urlpatterns += static(
